...
type CardVariant = "glass" | "chunky" | "flat"

const variantClasses: Record<CardVariant, string> = {
  glass: "glass-panel text-card-foreground",
  chunky: "chunky-surface bg-card text-card-foreground rounded-xl",
  flat: "bg-card text-card-foreground ring-1 ring-foreground/10",
}
